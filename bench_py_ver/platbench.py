...
def getArgs():
    ...
    parser.add_argument('--papiInclude', '-i', dest='papi_include', default='/gpfs/home/cs/sunjw/common/papi/include', help='path of papi include on this computer.')
    parser.add_argument('--papiLib', '-l', dest='papi_lib', default='/gpfs/home/cs/sunjw/common/papi/lib', help='path of papi lib on this computer.')
...
class Minibench:
    ...
    def fit(self):
        ...
        #l.append(self.pause_fit())
        #l.append(self.nop_fit())
        ...
        #l.append(self.l2cache_ins_fit())
        #l.append(self.l2cache_cyc_fit())
        #l.append(self.l2cache_lst_fit())
        cache_intercept = [self.l1cache_ins_fit(3),self.l1cache_cyc_fit(3),self.l1cache_lst_fit(3)]
                            #self.l2cache_ins_fit(3),self.l2cache_cyc_fit(3),self.l2cache_lst_fit(3)]
    ...
    def get_temp_code(self,s,env):
        ...
        os.environ["LD_LIBRARY_PATH"] = '/gpfs/home/cs/sunjw/common/papi/lib/'
    ...
    def add_fit(self):
        ...
        for i in range(4):
            ...
            #s += '{i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;i1=i2+i3+i4+i5+i6;}'
    ...
    def pause_fit(self):
        ...
        for i in range(4):
            t*=10
            x.append(t)
            s = f'\tfor (register long i = 0;i<{t};i++) __asm volatile(\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n\"pause\\n\\t\"\n);\n'
            metric = self.get_metrics(s)
            metric[1] -= t*3
            metric[0] -= t
            metric[-1] = 0.0
    ...
    def nop_fit(self):
        ...
        for i in range(4):
            t*=10
            x.append(t)
            s = f'\tfor (register long i = 0;i<{t};i++) __asm volatile(\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n\"nop\\n\\t\"\n);\n'
            metric = self.get_metrics(s)
            metric[1] -= t*3
            metric[0] -= t
            metric[-2] -= t
...
if __name__ == "__main__":
    args = getArgs()
    my_cmd_papi = ' -I' + args.papi_include + ' -L' + args.papi_lib + ' -std=c99 -lpapi '
    bench = Minibench(my_cmd_papi)
    # bench.get_cache_info()
    #print(bench.l1cache_lst_fit()
    #print(bench.msp2_fit())
    param_for_x = []
